...
function Enjoy() {
  return (
    <div className=''>
      <div className='bg-no-repeat bg-cover w-full h-full p-40' style={{ backgroundImage: `url(${Image})`}}>
        <div className='top-80 w-full flex items-center justify-center'>
        <div className='backdrop-blur-sm z-10 w-2/5 flex flex-col items-center justify-center p-20 border-8 border-yellow text-white space-y-5 tracking-wide'>
